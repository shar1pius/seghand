...
if __name__ == '__main__':
    ...
    parser.add_argument("--img_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/testimages/images', type=str)
    parser.add_argument("--twohands_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/testimages/pred_twohands', type=str)
    parser.add_argument("--cb_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/testimages/pred_cb', type=str)
    parser.add_argument("--obj1_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/testimages/pred_obj1', type=str)
    parser.add_argument("--obj2_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/testimages/pred_obj2', type=str)
    parser.add_argument("--vis_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/testimages/pred_obj1_vis', type=str)
