...
parser.add_argument("--hr_img_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/image', type=str)
parser.add_argument("--hr_lbl_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/label', type=str)
parser.add_argument("--img_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/image_512', type=str)
parser.add_argument("--lbl_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/label_512', type=str)
parser.add_argument("--lama_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/lama_512', type=str)
parser.add_argument("--lama_feat_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/lama_512_feature', type=str)
parser.add_argument("--aug_img_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/image_ccda', type=str)
parser.add_argument("--aug_lbl_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/label_ccda', type=str)
