...
parser.add_argument("--in_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/lama_512_pad', type=str)
parser.add_argument("--out_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/lama_512', type=str)
parser.add_argument("--ict_tf", default=False, type=bool)
parser.add_argument("--medfe_tf", default=False, type=bool)
parser.add_argument("--pad_info_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/image_512_pad_info', type=str)
