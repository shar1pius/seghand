...
parser.add_argument("--in_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/label_foreground_512', type=str)
parser.add_argument("--out_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/label_foreground_512_pad', type=str)
parser.add_argument("--pad_info_dir", default='/home/ubuntu/code/setup/confs/study/food_detect/EgoHOS/data/train/label_foreground_512_pad_info', type=str)
